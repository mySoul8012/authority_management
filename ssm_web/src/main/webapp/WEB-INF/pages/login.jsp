        ...
        <div class="sidebar">
            ...
            <nav class="mt-2">
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item">
                        <a href="/product/findAll.do#" class="nav-link">
                            <i class="nav-icon fas fa-file"></i>
                            <p>产品列表</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/user/findAll.do" class="nav-link">
                            <i class="nav-icon fas fa-file"></i>
                            <p>用户列表</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/Role/findAll.do" class="nav-link">
                            <i class="nav-icon fas fa-file"></i>
                            <p>角色列表</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/log/findAll.do" class="nav-link">
                            <i class="nav-icon fas fa-file"></i>
                            <p>日志列表</p>
                        </a>
                    </li>
                    <li class="nav-item">
                        <a href="/permission/findAll.do" class="nav-link">
                            <i class="nav-icon fas fa-file"></i>
                            <p>资源列表</p>
                        </a>
                    </li>
